...
public class HashExtensivel {
    ...
    class Cesto {
        ...
        short quantidadeMaxima;    // quantidade mÃ¡xima de pares que o cesto pode conter
        int[] chaves;              // sequÃªncia de chaves armazenadas no cesto
        long[] dados;               // sequÃªncia de dados correspondentes Ã s chaves
    ...
    class Diretório {
        ...
        protected long endereços(int p) {
            if (p > Math.pow(2, profundidadeGlobal)) {
                return -1;
            }
            return endereços[p];
    ...
    public HashExtensivel(int n, String nd, String nc) throws Exception {
        ...
        if (arqDiretorio.length() == 0 || arqCestos.length() == 0) {
            ...
            // Cria um novo diretório, com profundidade de 0 bits (1 Ãºnico elemento)
            diretório = new Diretório();
            byte[] bd = diretório.toByteArray();
            arqDiretorio.write(bd);

            // Cria um cesto vazio, já apontado pelo Ãºnico elemento do diretório
    ...
    public boolean create(int chave, long dado) throws Exception {
        ...
        // Recupera o cesto
        long endereçoCesto = diretório.endereços(i);
        Cesto c = new Cesto(quantidadeDadosPorCesto);
        ...
        if (c.read(chave) != -1) {
            throw new Exception("Chave jÃ¡ existe");
        }
